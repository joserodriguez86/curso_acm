---
title: "Clase 3a - Visualización de resultados"
...
Vamos a probar ahora agregar en la primera columna la etiqueta de la variable `empleo_f` y en en una fila superior la etiqueta de la variable `region_f`. Exploraremos algunas opciones de la función como `set_header_labels()`, `add_header_row()`, `add_footer_lines()`, `set_caption()`, `theme_vanilla()`, `align()` y `autofit()`. El resultado lo guardaremos en un objeto llamado `tabla_doc`.
