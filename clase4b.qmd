...
:::{.callout-tip}
Es recomendable explorar las librerías `factoExtra` y `dendextend` para la construcción de dendogramas. En este caso, utilizaremos las funciones de `R base` ya que al contar con una gran cantidad de observaciones esas librerías se vuelven lentas en el procesamiento. Un ejemplo de su uso pueden encontrarlo en este análisis sobre la discografía de [Spinetta](https://rpubs.com/josedelafuente/609181){target="_blank"} 
:::
